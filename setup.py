...
def run_command(command, description):
    ...
    # Windows uses yarn.cmd for Yarn commands.
    if command[0] == "yarn":
        command[0] = "yarn.cmd"
...
def main():
    ...
    try:
        ...
        print("\nIf Twenty CLI asks for authentication, run:")
        print("  yarn twenty remote:add")
        print("\nAuthenticate through the browser, then run this script again.")
        raise error
