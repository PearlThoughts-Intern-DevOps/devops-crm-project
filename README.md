...
This `terraform/` folder is one part of the overall Task 11 deliverable:
...
│   └── README.md
├── docs/
│   └── Task-11-Terraform-Documentation.md   # Full write-up of this task
└── screenshots/
    └── terraform-init-validate-success.png  # Proof of successful init/validate
```
...
```bash
cd terraform   # from the twenty-crm-task-11 project root
